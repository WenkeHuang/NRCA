...
mkdir -p $RESULT_DIR
 ...
 for IDX in $(seq 0 $((CHUNKS-1))); do
     CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
         ...
         --question-file /data0/data_wk/playground/DataEval/iconqa/fixed_iconqa_txt-test_addinstruct.jsonl \
         --image-folder /data0/data_wk/playground/images/iconqa \
...
output_file=$RESULT_DIR/$SPLIT/$CKPT/merge-iconqa.jsonl
...
python -m llava.eval.eval_iconqa \
    --annotation-file /data0/data_wk/playground/images/iconqa/fixed_iconqa_txt-test.jsonl \
