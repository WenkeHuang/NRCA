...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        ...
        --question-file /data0/data_wk/playground/DataEval/pope/llava_pope_test.jsonl \
...
output_file=$RESULT_DIR/$SPLIT/$CKPT/merge-pope.jsonl
...
python llava/eval/eval_pope.py \
    --annotation-dir /data0/data_wk/playground/DataEval/pope/coco \
    --question-file /data0/data_wk/playground/DataEval/pope/llava_pope_test.jsonl \
