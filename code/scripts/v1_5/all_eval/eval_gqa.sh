...
SPLIT="gqa"
RESULT_DIR=""
GQADIR="/data0/data_wk/playground/DataEval/gqa/data"
...
for IDX in $(seq 0 $((CHUNKS-1))); do
    CUDA_VISIBLE_DEVICES=${GPULIST[$IDX]} python -m llava.eval.model_vqa_loader \
        ...
        --question-file /data0/data_wk/playground/DataEval/gqa/llava_gqa_testdev_balanced.jsonl \
        --image-folder /data0/data_wk/playground/DataEval/gqa/data/images \
...
output_file=$RESULT_DIR/$SPLIT/$CKPT/merge-gqa.jsonl
